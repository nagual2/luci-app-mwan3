...
return view.extend({
	...
	render: function (stats) {
		...
		o = s.option(form.Flag, 'track_host_routes', _('Track host routes'),
			_('Override global track_host_routes for this interface (host /128 routes via mwan3 sync-track-routes).'));
		o.optional = true;
		o.modalonly = true;
